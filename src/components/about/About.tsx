      ...
      <motion.div id="whatAtmo" className="h-auto w-[82%] rounded-xl m-auto"
        ...
        <div className="flex items-center h-[14vh] m-auto">
            <div className="text-lg basis-2/6 pl-[50px]">
                <div className="rounded-xl w-[45px] h-[4px] bg-gradient-to-r from-sky-500 to-[#6936F5] mb-2"></div>
        ...
        <div className="flex justify-between mt-[70px] px-[50px]">
          <motion.h1 className="gradient__text text-3xl">Restoring balance to our environment</motion.h1>
          <motion.h3 className="gradient__text">Read our white paper</motion.h3>
        </div>
        <div>

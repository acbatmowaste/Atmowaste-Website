  ...
  <motion.div id="subscribe" className="app__newsletter rounded m-auto flex flex-col md:flex-row justify-start items-center md:h-[12vh] mt-12 md:mt-24"
    ...
    <div className="app__newsletter-input flex flex-row flex__center items-center grow md:pl-4">
      <form ref={form} onSubmit={sendEmail}>
        <input name="email" required type="email" className="text-black bg-white h-fit p-2 self-center md:px-4 basis-2/3" placeholder="Email address" />
        <input type="submit" value="SEND" className="ml-4 md:mr-2 border-[1px] custom__button text-white bg-black rounded h-fit p-2 self-center md:px-4 border-black">Subscribe</input>
      </form>
    </div>
  </motion.div>
};
